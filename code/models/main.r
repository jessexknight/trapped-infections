...
plot(ym,c('total'),color=variable,linetype=case); ggsave('leaks.pdf',w=8,h=4)
# plotting prev & foi
ym = y.melt(lapply(cases,solve))
plot(ym,c('prev_g','prev_k'),color=variable,linetype=case); ggsave('prev.pdf',w=8,h=4)
plot(ym,c('foi_g','foi_k'),  color=variable,linetype=case); ggsave('foi.pdf',w=8,h=4)
